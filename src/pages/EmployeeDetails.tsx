...
function EmployeeDetails() {
    ...
    //Handlers
    const discountPrice = (price: number, percentage: number | undefined) => {
      return price * (percentage! / 100);
    };
  
    const nextHandler = () => {
      setPreview((prev) => (prev === 800 - 1 ? 0 : prev + 1));
    };
    const prevHandler = () => {
      setPreview((prev) => (prev === 0 ? 800 - 1 : prev - 1));
    };
    ...
    const activeImageHandler = (key: React.SetStateAction<number>) => {
      setPreview(key);
    };
      ...
      <>
        <Body>
          ...
          <Details>
            ...
            <ProductDetails>
              <Description>we love descriptoion</Description>
              <Price>
                ...
                <div className="original-price">$20.00</div>
              </Price>
            </ProductDetails>
            <Buttons>
              <div className="quantity">
                ...
                <div className="current-quantity">90</div>
                <div
                  className="inc"
                  onClick={() => {
